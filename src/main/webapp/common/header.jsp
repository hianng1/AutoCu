...
<nav class="bg-orange-500 text-white">
  <div class="container mx-auto flex justify-between items-center whitespace-nowrap">
    ...
    <div class="flex items-center flex-nowrap">
      ...
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Xe oto cũ</a> <%-- Link placeholder --%>
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Phụ kiện xe</a> <%-- Link placeholder --%>
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Thuê xe</a> <%-- Link placeholder --%>
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Tin xe hơi</a> <%-- Link placeholder --%>
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Hỗ trợ</a> <%-- Link placeholder --%>
      <a href="#" class="px-4 py-3 hover:bg-orange-600 inline-block">Liên hệ</a> <%-- Link placeholder --%>
    </div>
