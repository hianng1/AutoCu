   ...
   <form action="${pageContext.request.contextPath}/sanpham/saveSanPham" 
      method="post" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <input type="text" name="productID" value="${sanPham.productID}" class="form-control" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label>Hãng xe</label>
            <input type="text" name="hangXe" value="${sanPham.hangXe}" class="form-control">
        </div>
        <div class="mb-3">
    ...
    <option value="${dm.categoryID}" 
        ...
        ${dm.categoryID} <!-- Hiển thị ID danh mục -->
    </option>
</c:forEach>
